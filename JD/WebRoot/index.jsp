...
<html>
	...
	<script type="text/javascript">
		$().ready(function(){
			$("#search").click(function(){
				window.location.href="product/searchAll";
			})
		})
	</script>
  </head>
  ...
  <body id="top">
		...
		<header id="header">
			<div class="header-box">
				...
				<ul class="header-right">
					...
					<%if(user==null){
						out.print("<a href='login/showLogin'>您好，请登录</a><li><a href='login/showRegister' class='red'> 免费注册</a> </li>");
					}else{
						out.print("<span>您好，"+user.getName()+"</span>");
					} %>
					<li class="shu"></li>
					<li class="denglu"><a href="order/showOrder">我的订单</a></li>
					<li class="shu"></li>
					<li class="my bj">
						<a href="#">我的京东</a>
						<i class="ci-right ">
		...
		<div class="w">
			...
			<div class="search">
				<input type="text" value="图书" class="text" id="textt">
...
<!--***********************************************-->
	<div class="lazy-fn lazy-fn-done" id="lazy-footer">        
		<div id="service-2014">
	<div class="slogen">
		 <img src="images/duo.png" width="1210px" alt="">
	</div>
	<div class="w">
		<dl class="fore1">
			<dt>购物指南</dt>
